...
describe('PromotionController (E2E)', () => {
  ...
  it('/v1/funcionarios/:funcionarioId/promocoes (POST) - Deve retornar erro ao promover o funcionário para a mesma função que ele já possui', async () => {
    ...
    expect(response.body).toEqual({
      statusCode: 409,
      message: 'O funcionário já possui essa função.',
      error: 'Conflict',
    });
  });
  ...
  it('/v1/funcionarios/:funcionarioId/promocoes (POST) - Deve cadastrar uma promoção', async () => {
    ...
    const response = await request(app.getHttpServer())
      .post(`/v1/funcionarios/${createdEmployee.id}/promocoes`)
      .send({ ...promotion, funcaoId: createdRole.id })
      .expect(201);
  ...
  it('/v1/empresas/:empresaId/promocoes (GET) - Deve listar todas as promoções de uma empresa', async () => {
    ...
    const response = await request(app.getHttpServer())
      .get(`/v1/empresas/${createdCompany.id}/promocoes`)
      .expect(200);
  ...
  it('/v1/empresas/:empresaId/promocoes (GET) - Deve retornar erro caso o ID da empresa não exista', async () => {
    const response = await request(app.getHttpServer())
      .get(`/v1/empresas/86f226c4-38b0-464c-987e-35293033faf6/promocoes`)
      .expect(404);
  ...
  it('/v1/funcionarios/:funcionarioId/promocoes (GET) - Deve retornar erro caso o ID do funcionário não exista', async () => {
    const response = await request(app.getHttpServer())
      .get(`/v1/funcionarios/86f226c4-38b0-464c-987e-35293033faf6/promocoes`)
      .expect(404);
